...
export const MAYA: EmployeeProfile = {
  ...
  projectIds: ['sample-collection', 'habitat-life-support', 'surface-power'], location: 'Pasadena, CA', accent: 'lilac',
  summary: 'Builds reliable embedded controls for sample handling, habitat sensors, and surface power protection.',
...
export const SCHEDULED_MEETING: Meeting = {
  id: 'weekly-contributions-2026-09-18', title: 'Weekly Contributions', projectId: 'habitat-life-support',
...
const MAYA_CONTRIBUTIONS: Contribution[] = [
  {
    ...
    date: '2026-09-05', skills: ['Embedded C++', 'Sensor Integration', 'Telemetry'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-08-28', skills: ['Embedded C++', 'Sensor Integration', 'Fault Detection'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-08-14', skills: ['Power Management', 'Embedded C++', 'Hardware-in-the-loop Testing'], status: 'APPROVED',
  ...
  {
    id: 'sample-carousel-recovery', employeeId: MAYA.id, meetingId: 'sample-handling-review-2026-07-31', projectId: 'sample-collection', category: 'UNBLOCKED',
    title: 'Recovered the sample carousel after a sensor dropout',
    description: 'Maya traced a stalled tube-transfer sequence to one noisy position sensor and added a safe fallback for returning the carousel home.',
    date: '2026-07-31', skills: ['Debugging', 'Sensor Integration', 'Fault Detection'], status: 'APPROVED',
    evidence: [{ quote: 'The position reading was flickering during the final turn. The fallback now stops the transfer, returns the carousel home, and preserves the tube identifier.', timestamp: '24:08', speaker: 'Maya Chen' }], sharedWithManager: true,
  },
  {
    id: 'habitat-telemetry-recovery', employeeId: MAYA.id, meetingId: 'habitat-controls-review-2026-06-19', projectId: 'habitat-life-support', category: 'RESEARCHED',
    title: 'Compared recovery options for delayed habitat readings',
    description: 'Maya tested two ways to restore buffered air-quality readings and recommended the approach that preserves their order after a controller reconnect.',
    date: '2026-06-19', skills: ['Telemetry', 'Embedded C++', 'Cross-team Collaboration'], status: 'APPROVED',
    evidence: [{ quote: 'Checkpointing each reading costs a little storage, but it was the only option that kept the oxygen and carbon-dioxide sequence intact after three forced disconnects.', timestamp: '31:26', speaker: 'Maya Chen' }], sharedWithManager: true,
  },
  {
    ...
    date: '2026-05-22', skills: ['Mentorship', 'Hardware-in-the-loop Testing', 'Cross-team Collaboration'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-04-10', skills: ['Technical Leadership', 'Power Management', 'Cross-team Collaboration'], status: 'APPROVED',
  ...
  {
    id: 'sample-handler-telemetry', employeeId: MAYA.id, meetingId: 'sample-handler-review-2026-03-13', projectId: 'sample-collection', category: 'IMPROVED',
    title: 'Made sample-handler faults easier to diagnose',
    description: 'Maya added the sensor state and recovery reason to each sample-handler fault report, reducing guesswork during test reviews.',
    date: '2026-03-13', skills: ['Telemetry', 'Debugging', 'Embedded C++'], status: 'APPROVED',
    evidence: [{ quote: 'The next report includes the tube sensor state before and after recovery, plus the exact rule that stopped the transfer sequence.', timestamp: '15:33', speaker: 'Maya Chen' }], sharedWithManager: true,
  },
  {
    id: 'power-log-buffer-note', employeeId: MAYA.id, meetingId: 'surface-power-review-2026-02-06', projectId: 'surface-power', category: 'RESEARCHED',
    title: 'Documented a controller log-buffer edge case',
    description: 'Maya documented how the power-controller log behaves when it fills during a restart and added the scenario to the next chamber test.',
    date: '2026-02-06', skills: ['Telemetry', 'Power Management'], status: 'APPROVED',
    evidence: [{ quote: 'I added the full-buffer restart case to the test plan so we can verify the battery events stay in order before the next chamber run.', timestamp: '38:12', speaker: 'Maya Chen' }], sharedWithManager: true,
  },
]
...
const TEAM_CONTRIBUTIONS: Contribution[] = [
  {
    ...
    date: '2026-09-12', skills: ['Hardware Testing', 'Sensor Integration', 'Systems Integration'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-08-21', skills: ['Embedded C++', 'Debugging', 'Hardware Testing'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-07-17', skills: ['Telemetry', 'Fault Detection', 'Systems Integration'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-09-10', skills: ['Robotic Manipulation', 'Motion Planning', 'Hardware Testing'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-08-07', skills: ['Motion Planning', 'Fault Detection', 'Autonomous Systems'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-06-26', skills: ['Technical Leadership', 'Test Planning', 'Cross-team Coordination'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-09-08', skills: ['Power Management', 'Thermal Systems', 'Power Budgeting'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-08-04', skills: ['Power Budgeting', 'Systems Analysis', 'Cross-team Collaboration'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-07-10', skills: ['Systems Integration', 'Power Management', 'Collaboration'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-09-11', skills: ['Mission Planning', 'Cross-team Coordination', 'Requirements Coordination'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-08-18', skills: ['Test Planning', 'Mission Operations', 'Cross-team Coordination'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-07-24', skills: ['Mission Operations', 'Requirements Coordination', 'Collaboration'], status: 'APPROVED',
...
export const OUTLOOK_CONTRIBUTIONS: Contribution[] = [
  {
    id: 'outlook-sample-calibration-handoff', employeeId: MAYA.id, projectId: 'sample-collection', category: 'SHIPPED',
    title: 'Documented the sample sensor calibration handoff',
    description: 'Maya sent the robotics team a concise calibration handoff so the sample-tube sensors could be checked before the next collection rehearsal.',
    date: '2026-09-17', skills: ['Sensor Integration', 'Cross-team Collaboration', 'Telemetry'], status: 'APPROVED',
    source: {
      provider: 'OUTLOOK', kind: 'EMAIL', title: 'Sample sensor calibration handoff', occurredAt: '2026-09-17T16:24:00-04:00',
      externalId: 'outlook-message-sample-calibration', sender: 'Maya Chen',
    },
    evidence: [{ quote: 'The tube-presence and temperature checks are now using the same calibration package. I added the verification steps and expected readings for Friday’s rehearsal.', timestamp: 'Sent at 4:24 PM', speaker: 'Maya Chen' }],
    sharedWithManager: true,
  },
  {
    id: 'outlook-power-cold-start-risk', employeeId: MAYA.id, projectId: 'surface-power', category: 'UNBLOCKED',
    title: 'Closed the cold-start power risk with the battery team',
    description: 'Maya summarized the final heater timing limits in Outlook and gave firmware and power engineers one agreed startup sequence to test.',
    date: '2026-09-03', skills: ['Power Management', 'Cross-team Collaboration', 'Embedded C++'], status: 'APPROVED',
    source: {
      provider: 'OUTLOOK', kind: 'EMAIL', title: 'Resolved: battery cold-start sequence', occurredAt: '2026-09-03T11:08:00-04:00',
      externalId: 'outlook-message-cold-start', sender: 'Maya Chen',
    },
    evidence: [{ quote: 'We now hold the auxiliary loads until the pack reaches the agreed temperature, then release them in two stages. Power and firmware are aligned on the same thresholds.', timestamp: 'Sent at 11:08 AM', speaker: 'Maya Chen' }],
    sharedWithManager: true,
  },
  {
    id: 'outlook-sample-status-ownership', employeeId: MAYA.id, projectId: 'sample-collection', category: 'LED',
    title: 'Clarified ownership for delayed sample-status updates',
    description: 'Maya turned a long email thread into a clear handoff for preserving tube identity, seal status, and cache-location updates.',
    date: '2026-08-26', skills: ['Technical Leadership', 'Telemetry', 'Cross-team Coordination'], status: 'APPROVED',
    source: {
      provider: 'OUTLOOK', kind: 'EMAIL', title: 'Ownership for delayed sample-status updates', occurredAt: '2026-08-26T14:36:00-04:00',
      externalId: 'outlook-message-sample-status-ownership', sender: 'Maya Chen',
    },
    evidence: [{ quote: 'Firmware will preserve the tube identifier and seal result; robotics will confirm the final cache location after the delayed update arrives. I added both owners to the rehearsal plan.', timestamp: 'Sent at 2:36 PM', speaker: 'Maya Chen' }],
    sharedWithManager: true,
  },
]

export const SEEDED_CONTRIBUTIONS: Contribution[] = [...OUTLOOK_CONTRIBUTIONS, ...MAYA_CONTRIBUTIONS, ...TEAM_CONTRIBUTIONS]
...
export const MEETING_RESULT_CONTRIBUTIONS: Contribution[] = [
  {
    ...
    date: '2026-09-18', skills: ['Sensor Integration', 'Embedded C++', 'Fault Detection'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-09-18', skills: ['Hardware Testing', 'Debugging', 'Collaboration'], status: 'APPROVED',
  ...
  },
  {
    ...
    date: '2026-09-18', skills: ['Technical Leadership', 'Cross-team Coordination'], status: 'APPROVED',
...
export const INITIAL_WORKSPACE_STATE: WorkspaceState = {
  contributions: [...SEEDED_CONTRIBUTIONS],
}
